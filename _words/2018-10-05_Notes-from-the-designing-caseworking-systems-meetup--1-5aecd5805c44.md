...
#### Presentation on Licensing for International Trade and Enterprise (LITE) {#2b48 .graf .graf--h4 .graf-after--p name="2b48"}
...
-   [Break down]{#8631}
-   [Whats the input?]{#45e0}
-   [Decisions to be made]{#55c0}
-   [Decision outcomes]{#3a99}
-   [Data required]{#5db6}
-   [Activities undertaken]{#67ad}
-   [Artefacts or proof]{#182c}
...
-   [[Types and stages of
    ...
    rel="noopener" target="_blank"}]{#8173}
-   [[Building internal systems v providing
    ...
    rel="noopener" target="_blank"}]{#4ac1}

### The afternoon workshop {#d02c .graf .graf--h3 .graf-after--li name="d02c"}
...
[Canonical
link](https://medium.com/@ctdesign/notes-from-the-designing-caseworking-systems-meetup-1-5aecd5805c44){.p-canonical}
